...
object ForeignCountries {
    ...
    private val TOKENS: Set<String> = setOf(
        ...
        "PR", "PRI", "PUERTO RICO",
        "CU", "CUB", "CUBA",
        "LATINO", "LATIN", "LATIN AMERICA", "SOUTH AMERICA", "CENTRAL AMERICA",
        "AMERICA LATINA", "CARIBBEAN", "CARIBE",
        ...
        "ZA", "ZAF", "SOUTH AFRICA",
        "ET", "ETH", "ETHIOPIA",
        "SOMALIA", "AFRICA", "ARABIC", "ARABIA", "MENA",
        // Asia and Oceania other than JP and KR
        "CN", "CHN", "CHINA", "CHINESE", "MANDARIN", "CANTONESE",
        "HK", "HKG", "HONG KONG",
        "TW", "TWN", "TAIWAN",
        "IN", "IND", "INDIA", "INDIAN", "HINDI", "TAMIL", "TELUGU", "PUNJABI", "MALAYALAM",
